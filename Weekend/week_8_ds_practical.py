# -*- coding: utf-8 -*-
"""Week 8 DS Practical.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1m4lCxemc_T_3QAJWybO99rVizXdcbmlb
...
# The 'affinity' and 'linkage' arguments might not be available
# in older versions of scikit-learn.
# If you encounter an error, try updating scikit-learn or
# removing these arguments if they are not required for your linkage method.
...
# Apply Agglomerative Clustering
hc = AgglomerativeClustering(n_clusters=4, linkage='ward')  # Remove affinity argument
y_hc = hc.fit_predict(X)
